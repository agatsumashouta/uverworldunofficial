  ...
  return (
    <div className='w-full'>
      ...
      <section id='Home' className='relative'>
        <h1 className="text-2xl absolute inset-0 md:text-5xl lg:text-9xl font-customFont2 text-white flex items-center justify-center text-center -top-1/4 -left-1/2">UVERworld</h1>
